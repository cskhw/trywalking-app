<template>
  <div class="picking-list-wrap">
    <h1>
      ...
      <VBtn icon="mdi-close" variant="text" color="secondary" />
    </h1>
...
import PickingListTable from "@/pages/home/picking/views/PickingListTable.vue";
import PickingListStoreInfo from "@/pages/home/picking/views/PickingListStoreInfo.vue";
import PickingListDeliveryInfo from "@/pages/home/picking/views/PickingListDeliveryInfo.vue";
...
.picking-list-wrap {
  ...
  ::v-deep(.v-badge--inline .v-badge__badge) {
    margin: 0 0 3px 8px;
  }
}
::v-deep.v-card {
